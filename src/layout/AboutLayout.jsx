                ...
                <section class="relative px-8 py-20 max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-16">
                    ...
                    <div class="flex-1 relative">
                        <div class="w-full aspect-[4/5] rounded-xl overflow-hidden shadow-2xl relative z-10">
                            <img class="w-full h-full object-cover" data-alt="A professional close-up photograph of a stylish Golden Retriever sitting gracefully in a sun-drenched, high-end pet boutique. The room features soft orange accents, light wood textures, and premium pet accessories in the background. The lighting is warm and editorial, emphasizing the soft texture of the dog's coat and the sophisticated, airy atmosphere of the atelier." src="https://lh3.googleusercontent.com/aida-public/AB6AXuCZHkFNQ9Fq45qL2aQKoSgOt1NiS1w-DLP6CB0thOUGqyCka-APmb3VZ31r9V7d2CuDGQdPWKdi0ofPiRMxaPSvUYjlHBPwdPEdI1UCm6yMEvGO9XDp6yPd52ZAkWsjB2W6_p0DE4_eyAmzWGCD7QkBG4IFPYMk5uwwnJixreODn7h-b-xV3UTkU8lYYqCtHi75Zz36rWmhYk0LueQQixRK3ubLOda6CL-jQj6b2uc81D2C6XVi1vphNbaA69ZULMcaqgdLVorDsCKB" />
                        </div>
                        ...
                        <div class="order-2 md:order-1">
                            <div class="grid grid-cols-2 gap-4">
                                <div class="aspect-square rounded-lg overflow-hidden translate-y-8">
                                    <img class="w-full h-full object-cover" data-alt="A detailed aesthetic shot of organic cotton pet toys and leather leashes neatly arranged on a minimalist white stone surface. The palette includes soft oranges and neutral cream tones, reflecting a clean, high-quality artisanal aesthetic. Soft shadows and natural daylight create a premium, curated feel." src="https://lh3.googleusercontent.com/aida-public/AB6AXuBjKJ8TI3QWVIG5AOGnO9XDjCm55XFHRlWEL6bkyEK-D_Ngxp8yYyGZ1rlX0VH_YknhqmqPrnpjJ6HrOx1SCPz1ownqIV0m02Rk-jvwJzR2RygsYav6gulbiErBTI_nq-ZuMsDNb4J1c9_qiU0k7UqbnTygrPB4PFvQB0uSYHaYxwjczHFBl4ayhvqUZervHHRucm4uqH5sy3Lj9JyNIrc6YlLDLX-v-mzCKRizLjMdQIjdsC282UR7SZ-zHrR_IabMLH12KDmBdRhe" />
                                </div>
                                <div class="aspect-square rounded-lg overflow-hidden">
                                    <img class="w-full h-full object-cover" data-alt="A candid, high-resolution portrait of a person gently grooming a cat with a high-end brush. The setting is bright and professional with a focus on precision and care. The background is softly blurred to emphasize the connection and quality of service, following the brand's sophisticated and approachable visual style." src="https://lh3.googleusercontent.com/aida-public/AB6AXuD71n8ayNdw4nqQgZOfcJdzJb_flVLUxSanQrI4SyUe_8gXwm5jPndfDVLwnDJaZtQrWVnShLuekwu6XzhihtKF4XGLV45DZKXLHktY1CgosdDJMzgk8xNTe8-PagPrBuTtIXwH15mqI_cMOJbm9XgVZYT3b8nyba6-x3RcRJENjFdkZxRAKxZu_hYQ4fzHn3hMXQ1flT5QxGoEroRDK0viVlXauwcPoZX_Yu-tezIGCackJhdLoxxObApNLqJ6DOLpWh0H8XRom4Y6" />
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-16">
                        <div class="group">
                            <div class="w-64 h-64 mx-auto mb-6 relative">
                                ...
                                <img class="relative w-full h-full object-cover rounded-full border-4 border-surface-container-lowest shadow-lg" data-alt="A professional and friendly portrait of a female founder with a warm smile, wearing a modern neutral blazer. The background is a bright, upscale boutique with soft orange accents. The lighting is flattering and studio-quality, conveying authority and approachability in a clean, high-end environment." src="https://lh3.googleusercontent.com/aida-public/AB6AXuD8FuiWXIOawqc_CYbOp0_NghWyE9bXdei3PsyrsrvVYuqFSWcj1JH2BsGacUkqZMFh3yt-FArX93KELI-fPZ8EtL45WPe1NDtTggGrSlmGqGkHjZ7xP7mH3NCOVUgVkiplBvWXpx-naGnsmlUr-HcxjLCJVFLEcLOgl_jRNkOzPw-0QZPhX64y_4Idna7ls1o7UL5IGdqvi0GqfYVZaTA8oJRPdajTllSwfqPaT41lqUEjHMLdObP0HSkfixncHcqNMkdzrE99d1JL" />
                            </div>
                        ...
                        <div class="group">
                            <div class="w-64 h-64 mx-auto mb-6 relative">
                                ...
                                <img class="relative w-full h-full object-cover rounded-full border-4 border-surface-container-lowest shadow-lg" data-alt="A portrait of a male veterinary expert in a clean, modern medical setting with warm wooden textures. He has a friendly, professional demeanor, representing trust and medical expertise. The environment is bright and airy, adhering to the boutique atelier aesthetic with premium lighting and sophisticated tones." src="https://lh3.googleusercontent.com/aida-public/AB6AXuDQ_4VQtxl1HzIaQRPjfc6ZMzqhNcSuGDIgq_bouuOiABQ_0HcDwOIaoWf3KuMILOkrDplirsChk55g1xOJBhJfnDcRmowL405T6-IjcrIkAKjO5Z4o7dtHDOkxZPCId6LRpq6T8VzJZ4RJkLzy_dTFTX7fc0DWv7K7bISTGzjwbSLttp3q1Rx-p3gamznd-5dDHXudU3lxEfB_YNejZt4jLoezqzM8QphG437WtkRzrkLY7jVndeRLQsQssX3DueLlhb8aJ9PPWwvX" />
                            </div>
                        ...
                        <div class="group">
                            <div class="w-64 h-64 mx-auto mb-6 relative">
                                ...
                                <img class="relative w-full h-full object-cover rounded-full border-4 border-surface-container-lowest shadow-lg" data-alt="A portrait of a female head groomer with a stylish and creative look, set against a backdrop of a high-end pet spa. The lighting is soft and bright, highlighting her friendly expression and the premium grooming tools neatly arranged behind her. The overall mood is professional, artistic, and welcoming." src="https://lh3.googleusercontent.com/aida-public/AB6AXuAtpsD2AivMWb8fEBSTio3-_tbldH4GIKrEGWICeUwOiY3CS8912xcPnyc5-uBDDE-t5r0GhvZ8DMzpdilwqV_c5sCFkpjhuEVN5KxFKmYgkSyd7S221A01822BZlCORrohoBV6fGfVnEDoAVbQzpXtZAvSQoeaUAGO3ifkG7a1Zz0vn2DUyH6HYaZdd23HUqMxKJj-Oze7WY44WU5CyFv70ya16zaBNZ28Sm12K284zSt4nKltfMODxYo_pxstYlcWqIWP7_fW25-V" />
                            </div>
                ...
                <section class="py-24 px-8 max-w-7xl mx-auto">
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-8 auto-rows-[300px]">
                        ...
                        <div class="md:col-span-2 relative rounded-xl overflow-hidden group">
                            <img class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700" data-alt="An wide, artistic shot of several happy dogs playing together in a beautiful, open green meadow during the golden hour. The soft evening sun creates a warm, glowing atmosphere. The scene captures pure joy and community, echoing the brand's commitment to pet happiness and organic experiences." src="https://lh3.googleusercontent.com/aida-public/AB6AXuCNW8hOEo7bPqlpHpO6L5qOxPNH6dcs1hfBcJOEy0LJ2gCVNMbRrfL4ukFz0aB29rV6yvlgd5tasDU5k4hFJEvNziiTUyW8_YWEYXcaSeJ5Q7n52rwuj-vUkQlZMs6ched8KJgS6Qy5O6_BU1BOsJyMuWuh3pwoSo2y9y_zFHZm1a-N-TZWZaru3zeL1f5GDz9XSt1B_MdQp-uFUO0wA46T-75PTmX4b8JNVyt5KXcHui7tXE2O64qYY8awurGSuPRgAbPe67K23C63" />
