            ...
            <div className="bg-white rounded-3xl shadow-2xl w-full max-w-lg max-h-[90vh] overflow-y-auto">
                ...
                <form onSubmit={handleSubmit} className="px-8 py-6 space-y-5">
                    ...
                    <div className="space-y-1.5">
                        ...
                        <input type="text" placeholder="e.g. Bestseller, New, Limited" value={form?.badge || ""}
...
export default function ManageCollarsLayout() {
    ...
    const handleAdd = (data) => addProduct({ ...data, category: "Paws & Play Signature" })
    ...
    return (
        <>
                                ...
                                <table className="w-full text-left">
                                    <thead>
                                        <tr className="bg-surface-container-low">
                                            ...
                                            <th className="px-6 py-4 text-xs font-black uppercase tracking-wider text-on-surface-variant">Badge</th>
                                    ...
                                    <tbody className="divide-y divide-surface-container-high">
                                        {collarProducts.length === 0 ? (
                                            ...
                                            <tr key={product.id} className="hover:bg-surface-container-low/50 transition-colors group">
                                                ...
                                                <td className="px-6 py-4">
                                                    {product.badge ? (
                                                        <span className="px-3 py-1 bg-surface-container-high rounded-full text-xs font-bold">{product.badge}</span>
                                                    ) : (
            ...
            <ProductModal isOpen={addOpen} onClose={() => setAddOpen(false)} onSave={handleAdd} initialData={defaultForm} title="Add New Collar Product" />
            <ProductModal isOpen={editOpen} onClose={() => { setEditOpen(false); setSelectedProduct(null) }} onSave={handleEdit} initialData={selectedProduct || defaultForm} title="Edit Collar Product" />
